...
#pragma config(Motor,  mtr_S1_C1_1,     motorDriveRight1, tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C1_2,     motorDriveLeft1, tmotorTetrix, openLoop, reversed)
...
#pragma config(Motor,  mtr_S1_C4_1,     motorFlag,     tmotorTetrix, openLoop, reversed)
