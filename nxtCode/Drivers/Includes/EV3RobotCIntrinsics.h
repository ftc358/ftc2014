...
//typedef enum tEV3MotorMasks
//{
//	// Motors that are synched D C B A
//  EV3MotorSync_None = 0,  // 0 0 0 0 = 0
//  EV3MotorSync_AB 	= 3,  // 0 0 1 1 = 3
//  EV3MotorSync_AC 	= 5,  // 0 1 0 1 = 5
//  EV3MotorSync_BC 	= 6,  // 0 1 1 0 = 6
//  EV3MotorSync_AD 	= 9,  // 1 0 0 1 = 9
//  EV3MotorSync_BD 	= 10, // 1 0 1 0 = 10
//  EV3MotorSync_CD 	= 12, // 1 1 0 0 = 12
//} tEV3MotorMasks;
...
//
// These are for testing purposes only and will be removed
//

// Synchronised motor control for a time period
//intrinsic void ev3MotorSyncTimeEx(tEV3MotorMasks nMotorMask, long nSignedPower, long nTurnRatio, unsigned long nTimeMsec, TMotorBrakeModes nBrakeMode)
//					asm(opcdEV3_ROBOTC, byte(ev3Fcn_MotorSyncTimeEx), variable(nMotorMask),
//					variable(nSignedPower), variable(nTurnRatio), variable(nTimeMsec), variable(nBrakeMode));

// Synchronsed motor control for a specified encder count
//intrinsic void ev3MotorSyncEncoderEx(tEV3MotorMasks nMotorMask, long nSignedPower, long nTurnRatio, unsigned long encoderCount, TMotorBrakeModes nBrakeMode)
//					asm(opcdEV3_ROBOTC, byte(ev3Fcn_MotorSyncEncoderEx), variable(nMotorMask),
//					variable(nSignedPower), variable(nTurnRatio), variable(encoderCount), variable(nBrakeMode));
