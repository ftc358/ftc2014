...
typedef enum TSystemFunctions
{
	...
	sysFuncDatalogAddPoint								= 41,
	sysFuncDataLogDefineDataPointName			= 42,
	sysFuncDataLogClear										= 43,
	#if defined(bHasDatalogSave) || defined(_WINDOWS)
		sysFuncDatalogSaveNext							= 44,
	#endif
#endif
...
typedef enum TSystemParmTypes
{
	...
	kSystemIncludeVelocityInVexCortexI2C				=  33,
#endif

#if defined(bHasRemoteButtons) || defined(_WINDOWS)
	kSystemRemoteButton                         =  34,
#endif
	...
	kSystemFloatDuringInactiveMotorPWM          =  40,
#endif
	...
	kSystemSendVariableLengthTestMessage        =  58,
	kSystemReplyVariableLengthTestMessage       =  59,

#if defined(bHasLCDContrast) || defined(_WINDOWS)
	kSystemLCDDefaultContrast                   =  60,  // Value stored in non-volatile memory and used on power up.
	kSystemLCDContrast													=  61,  // Contrast level for the LCD
#endif

#if defined(bHasDatalog) || defined(_WINDOWS)
	kSystemDatalogBufferSize                    =  62, // Number of entries in datalog
	kSystemUsedDatalogBytes                     =  63,
#endif
	...
	kSystemUserWantsExitButton									= 146,
#endif
...
typedef enum TMotorOpTypes
{
  ...
  mtrOpGetMotorStatus = 24,
	...
	//mtrOpGetTargetPositionAndVelocity,
} TMotorOpTypes;
#endif
...
typedef enum TEV3OpcodeFunctions
{
  ...
  ev3Fcn_MotorSyncTimeEx,
  ev3Fcn_MotorSyncEncoderEx,
...
typedef enum TUploadMsgTypes
{
	...
	uploadPIDSettings										= 15,
#endif

#if (defined(hasDebugStreamSupport) && !defined(NXT)) || defined(_WINDOWS)
	uploadReadDebugStreamWithSize				= 16,
	uploadReadDebugStreamNoSize					= 17,
#endif

#if (defined(hasDatalogStreamSupport) && !defined(NXT)) || defined(_WINDOWS)
	uploadReadDatalogStreamWithSize			= 18,
	uploadReadDatalogStreamNoSize				= 19,
#endif
...
#if defined(VexIQ) || defined(_WINDOWS)
	uploadVexIqDeviceTable							= 23,		// Applies to VEX IQ only
	uploadVexIqDeviceStatistics					= 24,		// Applies to VEX IQ only
#endif
} TUploadMsgTypes;
...
typedef enum TVMException
{
	...
	exceptionOpcodeNotSupportedInEmulationForArduino						= 52,

	exceptionVariableNotSupportedInEmulationForNXT							= 53,
	exceptionVariableNotSupportedInEmulationForVexPIC						= 54,
	exceptionVariableNotSupportedInEmulationForVexCortex				= 55,
	exceptionVariableNotSupportedInEmulationForVexIQ						= 56,
	exceptionVariableNotSupportedInEmulationForArduino					= 57,
	exceptionVariableNotSupportedInEmulationForEV3							= 58,
	...
	exceptionUserException1																			= 97,
	exceptionUserException2																			= 98,
	exceptionUserException3																			= 99,
