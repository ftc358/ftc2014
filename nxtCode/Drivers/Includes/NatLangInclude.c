...
// Choose Virtual World or Physical Robot:
	...
	#else
		#warning "Natural Language is not supported for this platform type (VIRTUAL WORLDS)."
	#endif
	...
	#else
		#warning "Natural Language is not supported for this platform type."
	#endif

#elif defined(_Target_Emulator_)
	#warning "Natural Language is not supported for 'Emulator' target.  Please select either Physical Robot or Virtual World"
